  ...
  public: {
    Tables: {
      ...
      diaries: {
        ...
        Relationships: [
          {
            foreignKeyName: "diaries_author_id_fkey"
            columns: ["author_id"]
            isOneToOne: false
            referencedRelation: "profiles"
            referencedColumns: ["id"]
      ...
      diary_days: {
        ...
        Relationships: [
          {
            foreignKeyName: "diary_days_diary_id_fkey"
            columns: ["diary_id"]
            isOneToOne: false
            referencedRelation: "diaries"
            referencedColumns: ["id"]
      ...
      diary_locations: {
        ...
        Relationships: [
          {
            foreignKeyName: "diary_locations_day_id_fkey"
            columns: ["day_id"]
            isOneToOne: false
            referencedRelation: "diary_days"
            referencedColumns: ["id"]
          ...
          {
            foreignKeyName: "diary_locations_diary_id_fkey"
            columns: ["diary_id"]
            isOneToOne: false
            referencedRelation: "diaries"
            referencedColumns: ["id"]
      ...
      saves: {
        ...
        Relationships: [
          {
            foreignKeyName: "saves_diary_id_fkey"
            columns: ["diary_id"]
            isOneToOne: false
            referencedRelation: "diaries"
            referencedColumns: ["id"]
      ...
      trip_plan_checklist_items: {
        ...
        Relationships: [
          {
            foreignKeyName: "trip_plan_checklist_items_trip_plan_id_fkey"
      ...
      trip_plans: {
        ...
        Relationships: [
          {
            foreignKeyName: "trip_plans_author_id_fkey"
            columns: ["author_id"]
            isOneToOne: false
            referencedRelation: "profiles"
            referencedColumns: ["id"]
          ...
          {
            foreignKeyName: "trip_plans_source_diary_id_fkey"
    ...
    Functions: {
      ...
      clone_trip_plan: {
        Args: { new_author_id: string; source_plan_id: string }
        Returns: string
      }
